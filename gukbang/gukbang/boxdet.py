...
class BlueRatioCirculator(Node):
    def __init__(self):
        ...
        self.U_detection_threshold = 122
        self.img_size_x = 848
        self.img_size_y = 480
        ...
        self.chess_model = YOLO("/home/ang/robot_ws/src/car_control/car_control/chess.pt")
        self.goodbox_model = YOLO("/home/ang/robot_ws/src/car_control/car_control/goodbox.pt")
