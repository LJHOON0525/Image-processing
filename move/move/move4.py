...
class BlueRatioCirculator(Node):
    def __init__(self):
        ...
        self.U_detection_threshold = 130# 140 white balance
        self.img_size_x = 848
        self.img_size_y = 480
        ...
        color_sensor.set_option(rs.option.white_balance, 6500)  # 수동 화이트밸런스 예시 #6500대 ballance but depth scale would be short than normal
