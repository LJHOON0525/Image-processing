...
class BlueRatioCirculator(Node):
    def __init__(self):
        ...
        self.U_detection_threshold = 170
        self.img_size_x = 848
        self.img_size_y = 480
    ...
    def yuv_detection(self, img):
        ...
        if max_contour is not None:
            ...
            roi_x_offset = int(self.img_size_x * 0.05)
    ...
    def image_processing(self):
        ...
        center_image_x = int(self.img_size_x / 2)
        cv2.line(self.color_img, (center_image_x, y1_roi), (center_image_x, y2_roi), (225, 130, 0), 2)

        error = center_image_x - self.center_x
        if error > 0:
            direction = "LEFT"
        elif error < 0:
            direction = "RIGHT"
        ...
        cv2.putText(self.color_img, f"{direction}", (30, 50),
    ...
    def track_tracking(self):
        ...
        if self.chess_detection_flag:
            ...
            error = center_image - center # 중앙선과 파란선 간 거리
